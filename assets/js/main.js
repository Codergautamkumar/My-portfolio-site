...
function scrollHeader(){
    ...
    //when the scroll is greater then 50 viewport height
...
// previously select topic //
const selectedTheme = localStorage.getItem('selected-theme')
const selectedIcon = localStorage.getItem('selected-icon')

// we obtain the currnet theme ///
...
const sendEmail = (e) =>{
    ...
    emailjs.sendForm('service_yk4rsvi', 'template_18brhdb', '#contact-form', '6911QUpDbkp_CWXeq')
    .then(() =>{
        // Show sent message
